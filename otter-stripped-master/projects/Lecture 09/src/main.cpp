...
bool initGLFW() {
	...
	// Lecture 9
	glfwWindowHint(GLFW_SAMPLES, 256); // MSAA 4x

	//Create a new GLFW window
	window = glfwCreateWindow(800, 800, "INFR1350 - Jeffrey - Li - 100712344", nullptr, nullptr);
...
void keyboardIcallback(GLFWwindow*, int key, int scancode, int action, int mods) {
...
int main() {
	...
	// Lecture 9
	glfwSetKeyCallback(window, keyboardIcallback);
